                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            <table class="table table-borderless">
                                <tr><th>Código</th><td><?= htmlspecialchars($medication->getCode() ?? '') ?></td></tr>
                                <tr><th>Nombre</th><td><?= htmlspecialchars($medication->getName() ?? '') ?></td></tr>
                                <tr><th>Principio Activo</th><td><?= htmlspecialchars($medication->getActiveName() ?: 'N/A') ?></td></tr>
                                <tr><th>Categoría</th><td><?= htmlspecialchars($medication->getCategory() ?? '') ?></td></tr>
                                <tr><th>Descripción</th><td><?= nl2br(htmlspecialchars($medication->getDescription() ?? '')) ?></td></tr>
                                <tr><th>Ubicación</th><td><?= htmlspecialchars($medication->getLocation() ?? '') ?></td></tr>
                                <tr><th>Stock Actual</th><td><strong><?= $medication->getStockTotal() ?></strong></td></tr>
                                <tr><th>Stock Mínimo</th><td><?= $medication->getMinimumStock() ?></td></tr>
                                <tr><th>Precio Venta</th><td>$<?= number_format($medication->getSalePrice(), 2) ?></td></tr>
                                <tr><th>Estado</th><td><?= $medication->getActive() ? '<span class="badge bg-success">Activo</span>' : '<span class="badge bg-secondary">Inactivo</span>' ?></td></tr>
                            </table>
                        </div>
                        <div class="card-footer">
                            <a href="<?= BASE_URL ?>medications.php?action=edit&id=<?= $medication->getIdMedication() ?>" class="btn btn-primary">Editar</a>
                ...
                <div class="col-lg-6">
                    <div class="card shadow-sm mb-4">
                        <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                            ...
                            <button type="button" class="btn btn-sm btn-light" data-bs-toggle="modal" data-bs-target="#addBatchModal">
