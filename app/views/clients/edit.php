                    ...
                    <form action="<?= BASE_URL ?>clients.php?action=update" method="POST" autocomplete="off">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-12 col-md-4">
                                ...
                                <input type="text" name="identification" class="form-control" maxlength="20"
                                       value="<?= htmlspecialchars($old['identification'] ?? $client->getIdentification()) ?>">
                            </div>
                            <div class="col-12 col-md-4">
                                <label class="form-label fw-bold small">Primer Nombre *</label>
                                <input type="text" name="name" class="form-control" required
                                       value="<?= htmlspecialchars($old['name'] ?? $client->getName()) ?>">
                            </div>
                            <div class="col-12 col-md-4">
                                <label class="form-label fw-bold small">Segundo Nombre</label>
                                <input type="text" name="middlename" class="form-control"
                                       value="<?= htmlspecialchars($old['middlename'] ?? $client->getMiddlename()) ?>">
                            </div>
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="lastname1" class="form-control" required
                                       value="<?= htmlspecialchars($old['lastname1'] ?? $client->getLastname1()) ?>">
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label fw-bold small">Apellido Materno</label>
                                <input type="text" name="lastname2" class="form-control"
                                       value="<?= htmlspecialchars($old['lastname2'] ?? $client->getLastname2()) ?>">
                            </div>
                        </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="phone" class="form-control" required
                                           value="<?= htmlspecialchars($old['phone'] ?? $client->getPhone()) ?>">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control"
                                           value="<?= htmlspecialchars($old['email'] ?? $client->getEmail()) ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-12">
                                ...
                                <textarea name="address" class="form-control" rows="2"><?= htmlspecialchars($old['address'] ?? $client->getAddress()) ?></textarea>
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-bold small">Observaciones</label>
                                <textarea name="observations" class="form-control" rows="2"><?= htmlspecialchars($old['observations'] ?? $client->getObservations()) ?></textarea>
                            </div>
                        </div>
